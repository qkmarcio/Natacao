                ...
                <table class="col-lg-12 table-fixed table style--3 table-hover" style="min-width: 900px;">
                    <thead>
                        <tr>
                            ...
                            <th class="col-5 text-left">Modalidade</th>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group px-2 col-lg-4" style="display: none">
                        <label>Codigo</label>
                        <input class="limpar form-control px-2" id="modalidade_id" disabled="">
                        <input id="insert" value="insert" style="display: none">
                    </div>
                    <div class="form-group px-2 col-lg-9">
                        <label name="modalidade_nome">Modalidade </label>
                        <input class="limpar form-control px-2" id="modalidade_nome" name="modalidade_nome">
                    </div>
                    <div class="form-group px-2 col-lg-3">
                        <label >Status</label>
                        <select class="form-control px-2" id="modalidade_ativado" >
                    ...
                    <div class="form-group px-2 col-lg-12">
                        <label>Obs</label>
                        <textarea class="limpar form-control px-2" id="modalidade_obs" rows="3"></textarea>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    loadjscssfile('../js/jModalidade.js?nocache=' + Math.random(), 'js');
