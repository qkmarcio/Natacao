...
CREATE TABLE `tab_alunos` (
  ...
  `alu_nivel_nome` varchar(50) DEFAULT NULL COMMENT 'qual é o nivel do aluno grava na tab_mensalidade',
  `alu_nivel_id` int(11) DEFAULT '0',
  PRIMARY KEY (`alu_id`),
  UNIQUE KEY `alu_id_UNIQUE` (`alu_id`),
  KEY `fk_tab_alunos_tab_aulas1_idx` (`alu_nivel_id`),
  CONSTRAINT `fk_tab_alunos_tab_aulas1` FOREIGN KEY (`alu_nivel_id`) REFERENCES `tab_aulas` (`aul_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tab_alunos` VALUES (1,'MARCIO OLIVEIRA DE SOUZA','1983-12-08','MARCIO','85851-170','CENTRO','RUA RUI BARBOSA','FOZ DO IGUAçU','036.619.139-05','(45) 9999-9999','(45) 99999-9999','MASCULINO','qkmarcio@gmail.com','0','teste obs','undefined','1','../Fotos/imgAluno/62754541c4ed0.jpg','2022-05-05 07:19:53','2 - AULA2 - JOAQUIM',2),(2,'NAR','1921-12-12','JESSICA','85851-170','CENTRO','RUA RUI BARBOSA','FOZ DO IGUAçU','036.619.139-05','(45) 4544-5454','(66) 45446-5446','MASCULINO','qkmarcio@gmail.com','0','asdasd','undefined','0','../Fotos/imgAluno/627547f7c0147.jpg','2022-05-05 11:19:21','3 - AULA3 - HENRIQUE',3);
...
CREATE TABLE `tab_aulas` (
  ...
  `aul_dia_semana` varchar(50) NOT NULL,
...
INSERT INTO `tab_aulas` VALUES (1,'AULA1','15:45','SEGUNDA,TERÇA','TESTE',0,'1',10,'2022-04-25 21:47:58'),(2,'AULA2','15:36','SEGUNDA,QUINTA','SSDFASDF',0,'1',11,'2022-04-25 23:11:56'),(3,'AULA3','15:40','SEXTA','',0,'1',10,'2022-04-25 23:12:49');
...
INSERT INTO `tab_contratos` VALUES (1,'2022-05-05',400,8,'TESTE','1','0','2022-05-27 07:53:11',1,1),(2,'2022-06-06',250,5,'TESTE','1','0','2022-06-03 12:02:20',1,1);
...
CREATE TABLE `tab_mensalidades` (
  ...
  `men_nivel_aluno_nome` varchar(50) DEFAULT NULL COMMENT 'qual nivel do aluno na epoca do pagamento da mensalidade',
  `men_nivel_aluno_id` int(11) DEFAULT '0',
  PRIMARY KEY (`men_id`),
  KEY `fk_tab_mensalidades_tab_contratos1_idx` (`contratos_id`),
  KEY `fk_tab_mensalidades_tab_aulas1_idx` (`men_nivel_aluno_id`),
  CONSTRAINT `fk_tab_mensalidades_tab_aulas1` FOREIGN KEY (`men_nivel_aluno_id`) REFERENCES `tab_aulas` (`aul_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tab_mensalidades` VALUES (1,'2022-05-05','2022-05-05','3',400,400,0,'2022-05-27 07:53:11',1,'Dinheiro','',NULL,NULL),(2,'2022-06-07','2022-06-07','3',400,400,0,'2022-05-27 07:53:11',1,'Deposito(Pix)','',NULL,NULL),(3,'2022-07-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(4,'2022-08-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(5,'2022-09-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(6,'2022-10-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(7,'2022-11-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(8,'2022-12-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(9,'2023-01-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(10,'2023-02-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(11,'2023-03-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(12,'2023-04-05',NULL,'1',400,0,0,'2022-05-27 07:53:11',1,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(13,'2022-06-06',NULL,'0',250,0,0,'2022-06-03 12:02:20',2,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(14,'2022-07-06',NULL,'0',250,0,0,'2022-06-03 12:02:21',2,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(15,'2022-08-06',NULL,'0',250,0,0,'2022-06-03 12:02:21',2,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(16,'2022-09-06',NULL,'0',250,0,0,'2022-06-03 12:02:21',2,NULL,NULL,'2 - AULA2 - JOAQUIM',2),(17,'2022-10-06',NULL,'0',250,0,0,'2022-06-03 12:02:21',2,NULL,NULL,'2 - AULA2 - JOAQUIM',2);
...
-- Dump completed on 2022-06-04 11:58:41
